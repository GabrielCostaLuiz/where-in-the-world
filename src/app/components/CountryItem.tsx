...
export const CountryItem = ({ name, population, region, capital, flag }: Countryitem) => {
  ...
  <div className=''>
    <Link href={`pages/country/${name.common}`}>
      ...
      <div className={` bg-gray-100 rounded shadow-md transform transition-transform duration-300 ease-in-out hover:scale-105 ${theme==='dark'?'bg-gray-700 text-white':null} min-h-80`}>
